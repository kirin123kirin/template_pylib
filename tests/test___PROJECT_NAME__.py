...
try:
    ...
    try:
        from ___PROJECT_NAME__ import *
        kw = {"setup": "from ___PROJECT_NAME__ import *"} if PY2 else {}
    except ImportError:
        from __PROJECT_NAME__.___PROJECT_NAME__ import *
        kw = {"setup": "from __PROJECT_NAME__.___PROJECT_NAME__ import *"} if PY2 else {}
